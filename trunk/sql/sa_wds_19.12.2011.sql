...
INSERT INTO `page` VALUES ('113', '1', 'New page', null, null);
...
-- ----------------------------
INSERT INTO `page_question` VALUES ('113', '3');
INSERT INTO `page_question` VALUES ('13', '4');
INSERT INTO `page_question` VALUES ('113', '5');
INSERT INTO `page_question` VALUES ('14', '6');
INSERT INTO `page_question` VALUES ('14', '7');
INSERT INTO `page_question` VALUES ('113', '7');
...
INSERT INTO `question` VALUES ('4', 'N', 'N', 'N', 'Do you have a specific budget range already established for this \nproject?', 'Multiple Choice', 'N', '1');
INSERT INTO `question` VALUES ('5', 'N', 'N', 'N', 'How did you hear about us?', 'Multiple Choice', 'N', '2');
INSERT INTO `question` VALUES ('6', 'N', 'N', 'N', 'Are you satisfied with our customer service?', 'Multiple Choice', 'N', '1');
INSERT INTO `question` VALUES ('7', 'N', 'N', 'N', 'How often to go into a restaurant for a meal?', 'Multiple Choice', 'N', '3');
...
INSERT INTO `survey_page` VALUES ('6', '113');
...
-- ----------------------------
-- Procedure structure for `countQuestionsInUse`
-- ----------------------------
DROP PROCEDURE IF EXISTS `countQuestionsInUse`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `countQuestionsInUse`(IN `idIn` integer,OUT `numberOfQuestionsInUse` integer)
BEGIN
	#Routine body goes here...
	SELECT COUNT(*)
	INTO numberOfQuestionsInUse
	FROM page_question
	WHERE questionid = idIn;
END
;;
DELIMITER ;
