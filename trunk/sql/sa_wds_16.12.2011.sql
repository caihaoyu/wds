...
INSERT INTO `answer` VALUES ('164', null, 'a1');
INSERT INTO `answer` VALUES ('165', null, 'a2');
INSERT INTO `answer` VALUES ('168', null, 'a1');
INSERT INTO `answer` VALUES ('169', null, 'a2');
INSERT INTO `answer` VALUES ('172', null, 'a1');
INSERT INTO `answer` VALUES ('173', null, 'a2');
INSERT INTO `answer` VALUES ('178', null, 'a1');
INSERT INTO `answer` VALUES ('179', null, 'a2');
INSERT INTO `answer` VALUES ('184', null, 'a1');
INSERT INTO `answer` VALUES ('185', null, 'a2');
INSERT INTO `answer` VALUES ('192', null, 'a1');
INSERT INTO `answer` VALUES ('193', null, 'a2');
INSERT INTO `answer` VALUES ('200', null, 'a1');
INSERT INTO `answer` VALUES ('201', null, 'a2');
INSERT INTO `answer` VALUES ('207', null, 'a1');
INSERT INTO `answer` VALUES ('208', null, 'a2');
INSERT INTO `answer` VALUES ('213', null, 'a1');
INSERT INTO `answer` VALUES ('214', null, 'a2');
INSERT INTO `answer` VALUES ('219', null, 'a1');
INSERT INTO `answer` VALUES ('220', null, 'a2');
INSERT INTO `answer` VALUES ('225', null, 'a1');
INSERT INTO `answer` VALUES ('226', null, 'a2');
INSERT INTO `answer` VALUES ('231', null, 'a1');
INSERT INTO `answer` VALUES ('232', null, 'a2');
INSERT INTO `answer` VALUES ('238', null, 'a1');
INSERT INTO `answer` VALUES ('239', null, 'a2');
INSERT INTO `answer` VALUES ('243', null, 'a1');
INSERT INTO `answer` VALUES ('244', null, 'a2');
INSERT INTO `answer` VALUES ('249', null, 'a1');
INSERT INTO `answer` VALUES ('250', null, 'a2');
...
CREATE TABLE `groups` (
  ...
  `username` char(22) DEFAULT NULL,
  `groupname` char(22) DEFAULT NULL,
  PRIMARY KEY (`groupid`)
...
-- Records of groups
-- ----------------------------
INSERT INTO `groups` VALUES ('1', 'sam', 'administrator');
INSERT INTO `groups` VALUES ('2', 'viona', 'user');
...
-- Records of page
-- ----------------------------
INSERT INTO `page` VALUES ('13', '1', 'This is a new page-924103589', null, null);
INSERT INTO `page` VALUES ('14', '2', 'This is a new page351356377', null, null);
INSERT INTO `page` VALUES ('40', '3', 'This is a new page-148338553', null, null);
...
CREATE TABLE `page_question` (
  ...
  PRIMARY KEY (`pageid`,`questionid`),
  KEY `FK4C877B962C582A37` (`questionid`),
  KEY `FK4C877B96B1815949` (`pageid`),
  CONSTRAINT `FK4C877B962C582A37` FOREIGN KEY (`questionid`) REFERENCES `question` (`questionid`),
  CONSTRAINT `FK4C877B96B1815949` FOREIGN KEY (`pageid`) REFERENCES `page` (`pageid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- ----------------------------
-- Records of page_question
-- ----------------------------
INSERT INTO `page_question` VALUES ('13', '3');
INSERT INTO `page_question` VALUES ('13', '4');
INSERT INTO `page_question` VALUES ('14', '6');
INSERT INTO `page_question` VALUES ('14', '7');
INSERT INTO `page_question` VALUES ('40', '8');
INSERT INTO `page_question` VALUES ('13', '15');
...
INSERT INTO `question` VALUES ('7', 'N', 'N', 'N', 'How often to go into a restaurant for a meal?', 'Multiple Choice', 'N', '2');
INSERT INTO `question` VALUES ('8', 'N', 'N', 'N', 'How would you rate your experience with Customer Support?', 'Matrix', 'N', '1');
...
INSERT INTO `question` VALUES ('17', 'N', 'N', 'N', 'I learned about YOUR COMPANY from:', 'Multiple Choice', 'N', null);
INSERT INTO `question` VALUES ('18', 'N', 'N', 'N', 'Primary purpose of website:', 'Multiple Choice', 'N', null);
...
-- ----------------------------
INSERT INTO `survey_page` VALUES ('5', '13');
INSERT INTO `survey_page` VALUES ('5', '14');
INSERT INTO `survey_page` VALUES ('5', '40');
