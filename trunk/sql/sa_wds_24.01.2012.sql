...
CREATE TABLE `pagebranch` (
  ...
  KEY `FK662D20F1B1815949` (`pageid`),
  CONSTRAINT `FK662D20F1B1815949` FOREIGN KEY (`pageid`) REFERENCES `page` (`pageid`)
) ENGINE=InnoDB AUTO_INCREMENT=291 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- ----------------------------
-- Records of pagebranch
-- ----------------------------
INSERT INTO `pagebranch` VALUES ('280', 'Branch 1', '0', null);
INSERT INTO `pagebranch` VALUES ('281', 'Default Branch', '1', null);
INSERT INTO `pagebranch` VALUES ('284', 'Default Branch', '1', null);
INSERT INTO `pagebranch` VALUES ('285', 'Branch 2', '0', null);
INSERT INTO `pagebranch` VALUES ('288', 'Default Branch', '1', null);
INSERT INTO `pagebranch` VALUES ('290', 'Branch 3', '0', null);
...
-- ----------------------------
INSERT INTO `pagebranch_question` VALUES ('281', '7');
INSERT INTO `pagebranch_question` VALUES ('281', '3');
INSERT INTO `pagebranch_question` VALUES ('281', '5');
