...
Source Database       : sa_wds2

Target Server Type    : MYSQL
Target Server Version : 50509
File Encoding         : 65001

Date: 2012-01-25 01:27:30
*/
...
-- ----------------------------
-- Table structure for `questionrule_condition`
-- ----------------------------
DROP TABLE IF EXISTS `questionrule_condition`;
CREATE TABLE `questionrule_condition` (
  `ruleid` int(11) NOT NULL,
  `conditionid` int(11) NOT NULL,
  PRIMARY KEY (`ruleid`,`conditionid`),
  KEY `conditionid_index` (`conditionid`) USING BTREE,
  KEY `ruleid_index` (`ruleid`) USING BTREE,
  CONSTRAINT `questionrule_condition_ibfk_2` FOREIGN KEY (`conditionid`) REFERENCES `condition` (`conditionid`),
  CONSTRAINT `questionrule_condition_ibfk_1` FOREIGN KEY (`ruleid`) REFERENCES `questionrule` (`ruleid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of questionrule_condition
-- ----------------------------
